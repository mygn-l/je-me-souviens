...
menu_config.menu.append(new menu_class.link("Crise subside", "Crise subside"));
...
menu_config.menu.append(
  new menu_class.link("Rebellion du Haut Canada", "Rebellion du Haut Canada")
);
menu_config.menu.append(new menu_class.intertitle("Apres guerre"));
menu_config.menu.append(new menu_class.link("Apres guerre", "Apres guerre"));
menu_config.menu.append(new menu_class.link("Rapport durham", "Rapport durham"));
menu_config.menu.append(new menu_class.intertitle("Mouvements revolutionnaires"));
menu_config.menu.append(
  new menu_class.link("Mouvements revolutionnaires", "Mouvements revolutionnaires")
);
menu_config.menu.append(new menu_class.link("Acte d'union", "Acte d'union"));
menu_config.menu.append(new menu_class.link("Hommage aux morts", "Hommage aux morts"));
menu_config.menu.append(new menu_class.link("Acte constitutionnel", "Acte constitutionnel"));
...
menu_config.pages.append(crise_agricole);
...
menu_config.pages.append(crise_subside);
...
menu_config.pages.append(rebellion_haut_canada);
...
menu_config.pages.append(apres_guerre);
...
menu_config.pages.append(rapport_durham);
...
menu_config.pages.append(mouvement_revolutionnaire);
...
menu_config.pages.append(acte_union);
...
menu_config.pages.append(hommage);
...
acte_constitutionnel.append(new page_class.parag(fs.readFileSync(__dirname + "/txt/Acte-constitutionnel.txt", "utf8")));
menu_config.pages.append(acte_constitutionnel);
